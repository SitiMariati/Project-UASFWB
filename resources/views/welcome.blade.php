...
<head>
  ...
  <title>Index - Pembelian tiket bioskop online</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link href="{{asset('instan')}}/assets/img/favicon.png" rel="icon">
  <link href="{{asset('instan')}}/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="{{asset('instan')}}/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="{{asset('instan')}}/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="{{asset('instan')}}/assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="{{asset('instan')}}/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="{{asset('instan')}}/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">

  <!-- Main CSS File -->
  <link href="{{asset('instan')}}/assets/css/main.css" rel="stylesheet">

  <!-- Custom CSS untuk memperbesar tampilan -->
  <link href="{{asset('instan')}}/assets/css/custom.css" rel="stylesheet">
...
<body class="index-page">
        ...
        <div class="hero-wrapper">
          ...
          <div class="hero-main-content text-center">
            <h1 class="hero-title" data-aos="zoom-in" data-aos-delay="200">
              ...
              <span class="typed" data-typed-items="Pembelian Tiket Bioskop Online"></span>
            </h1>

            <p class="hero-description" data-aos="fade-up" data-aos-delay="300">
             Memudahkan anda untuk membeli tiket bioskop tanpa harus mengantri
            </p>
            ...
            <div class="hero-actions" data-aos="fade-up" data-aos-delay="300">
              ...
              <a href="{{route('register')}}" class="action-btn secondary glightbox">
                <i class=""></i>
                <span>Register</span>
              </a>
            </div>
  ...
  <!-- Vendor JS Files -->
  <script src="{{asset('instan')}}/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="{{asset('instan')}}/assets/vendor/php-email-form/validate.js"></script>
  <script src="{{asset('instan')}}/assets/vendor/aos/aos.js"></script>
  <script src="{{asset('instan')}}/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="{{asset('instan')}}/assets/vendor/purecounter/purecounter_vanilla.js"></script>
  <script src="{{asset('instan')}}/assets/vendor/typed.js/typed.umd.js"></script>
  <script src="{{asset('instan')}}/assets/vendor/swiper/swiper-bundle.min.js"></script>

  <!-- Main JS File -->
  <script src="{{asset('instan')}}/assets/js/main.js"></script>
