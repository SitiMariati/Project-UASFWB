...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Jadwal Tayang</h1>
            ...
            <form action="{{ route('admin.jadwal.update', $jadwal->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('film_id') is-invalid @enderror" id="film_id" name="film_id" required>
                        ...
                        @foreach($films as $film)
                            <option value="{{ $film->id }}" {{ old('film_id', $jadwal->film_id) == $film->id ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tanggal_tayang') is-invalid @enderror" 
                           id="tanggal_tayang" name="tanggal_tayang" value="{{ old('tanggal_tayang', $jadwal->tanggal_tayang) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="time" class="form-control @error('jam_tayang') is-invalid @enderror" 
                           id="jam_tayang" name="jam_tayang" value="{{ old('jam_tayang', $jadwal->jam_tayang) }}" required>
                    @error('jam_tayang')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('harga_tiket') is-invalid @enderror" 
                           id="harga_tiket" name="harga_tiket" value="{{ old('harga_tiket', $jadwal->harga_tiket) }}" min="1000" step="1000" required>
                    @error('harga_tiket')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
